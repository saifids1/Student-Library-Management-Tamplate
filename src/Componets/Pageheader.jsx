  ...
  return (
    <>
      <div className="heading d-flex bg-primary text-white rounded mb-2">
        ...
        <div className="w-25 text-end menu-btn" >
          {/* <i class="fa-solid fa-circle-chevron-down"></i> */}
          <button  className="btn btn-primary" onClick={handleMenuBar}>☰</button>
        </div>
      </div>
        <div className={`menu-bar justify-content-end text-end ${isMenuOpen ? "d-flex" : "d-none"}`}>
      <ul>
        {/* Create Student */}
        <li>
          <NavLink
